export const en = {
  ...
  myProfile: {
    attention: 'Attention!',
    looseTree: 'You have {{treesLength}} {{treeText}} planted in offline mode and {{treeThereText}} waiting to submit, if you logout now, you will loose your {{treeText}}!',
  ...
  settings: {
    ...
    gsnDetails: 'Treejer sponsors your transaction fees. If your transactions are being failed, you can switch off sponsorship. Please remember you need MATIC token in your wallet send transactions. You may ask your rural ambassador for more help.',
  ...
  inValidImage: {
    ...
    message: "You can't upload this image because you didn't take this photo, or your GPS was off when you were taking that photo with the Camera.",
    hasNoLocation: "This image doesn't have location metadata please go to your camera settings and allow location permission. \nIf you still have trouble you can try to upload photo from gallery",
  ...
  checkPermission: {
    ...
    cantProceedDesc: 'To plant a tree and nursery or upload a tree we need location, camera, and media permissions to acuurateyour activities and detect fraud.'
  },
  map: {
    newTree: {
