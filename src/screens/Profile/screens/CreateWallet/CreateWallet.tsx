  ...
  return (
    <ScrollView style={[globalStyles.screenView, globalStyles.fill]}>
      ...
      >
        <Spacer times={8} />
        <View
          style={[globalStyles.horizontalStack, globalStyles.alignItemsCenter]}
        >
            ...
            <View>
              ...
              {currentStep > 1 ? (
                ...
                <>
                  ...
                  />
                  <Spacer times={1} />
                  <Text style={globalStyles.normal}>
                    Some hint about the password
                  </Text>
                  <Spacer times={3} />
            ...
            <View style={{ alignItems: "flex-start" }}>
              ...
              {currentStep === 2 && (
                <>
                  <Spacer times={2} />
                  <View
                    style={[globalStyles.horizontalStack, { flexWrap: "wrap" }]}
                  >
                    {recoveryPhrase.map((word) => (
                      <Text
                        key={word}
                        style={[globalStyles.normal, styles.word]}
                      >
                        {word}
                      </Text>
                    ))}
