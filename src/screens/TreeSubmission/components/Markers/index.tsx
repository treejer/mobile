...
import {geoJSONType, ON_SITE} from 'utilities/helpers/inventoryConstants';
...
const PointAnnotationMarker = ({
  ...
  let coordinates = type === 'Polygon' ? onePolygon.geometry.coordinates[0] : onePolygon.geometry.coordinates;
  ...
  if (onePolygon.geometry.type === 'Point') {
    markers.push(
      ...
      >
        <MarkerSVG point={alphabets[i]} color={nonDragablePoint ? colors.grayLight : colors.green} />
    ...
    for (let j = 0; j < iterationCount; j++) {
      ...
      markers.push(
        ...
        >
          <MarkerSVG point={alphabets[j]} color={colors.green} />
        </MapboxGL.PointAnnotation>,
      );
    }
  }
